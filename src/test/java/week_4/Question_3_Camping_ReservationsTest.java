 ...
 */
public class Question_3_Camping_ReservationsTest {
    
    @Test(timeout = 3000)
    public void testSearchTentWater() {
        List<String> results = Question_3_Camping_Reservations.getMatchingSites("TENT", true);
    ...
    public void testSearchTentNoWater() {
        List<String> results = Question_3_Camping_Reservations.getMatchingSites("TENT", false);
    ...
    public void testSearchRVWater() {
        List<String> results = Question_3_Camping_Reservations.getMatchingSites("RV", true);
    ...
    public void testSearchRVNoWater() {
        List<String> results = Question_3_Camping_Reservations.getMatchingSites("RV", false);
